...
const StockLedgerEntry = sequelize.define('StockLedgerEntry', {
  ...
  quantityIn: { type: DataTypes.DECIMAL(10, 2), allowNull: false, defaultValue: 0 },
  quantityOut: { type: DataTypes.DECIMAL(10, 2), allowNull: false, defaultValue: 0 },
  balanceAfter: { type: DataTypes.DECIMAL(10, 2), allowNull: false, defaultValue: 0 },
